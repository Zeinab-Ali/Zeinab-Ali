...
class Product extends Model implements ConnectTo
{
    ...
    {
        $query = "SELECT `id`,`name_en`,`image`,`details_en`,`price` FROM `products` WHERE `status` = ? ORDER BY `created_at` DESC ";
        $stmt = $this->con->prepare($query);
        $stmt->bind_param('i', $status);
        $stmt->execute();
        return $stmt;
    ...
    {
        $query = "SELECT `id`,`name_en`,`image`,`details_en`,`price` FROM `products` WHERE `status` = ? AND `subcategory_id` = ? ORDER BY `price` ASC , `name_en` ASC";
        $stmt = $this->con->prepare($query);
    ...
    {
        $query = "SELECT `id`,`name_en`,`image`,`details_en`,`price` FROM `product` WHERE `status` = ? AND `brand_id` = ? ORDER BY `price` ASC , `name_en` ASC";
        $stmt = $this->con->prepare($query);
    ...
    {
        $query = "SELECT `id`,`name_en`,`image`,`details_en`,`price` FROM `product` WHERE `status` = ? AND `category_id` = ? ORDER BY `price` ASC , `name_en` ASC";
        $stmt = $this->con->prepare($query);
